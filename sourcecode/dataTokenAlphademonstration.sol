...
contract DataTokenAlpha {
    ...
    */
    ...
    string private tokenName = "DataToken";
    //
    string private tokenSymbol = "DAT";
    //
    uint256 private totalSupply = 666 * 10 ** 9;// DAT
    ...
    */
    ...
    uint256 private reportPeriod = 30; // sec
    //within such time difference, two data usage report are considered as "synchronized"
    uint256 private coherenceTime = 60; // sec
    //DataToken Price
    uint256 private tokenPrice = 10 ** 9;// wei/DAT
    //acceptable reported data traffic difference
    uint256 private usageTolerance = 10;// MB 
    ...
    */
    ...
    uint256 private APID_counter = 1;
    ...
    */
    ...
    internal
    {
        ...
        emit LogSur(msg.sender, _newrole, true);
    }
    ...
    */
    function _affordableData (address _wallet, uint256 _APID)
    internal
    view
    returns (uint256 valid)
    {
        ...
        valid = temp_balance/temp_price;// > usageTolerance is acceptable
        return valid;
    }
    ...
    */
    ...
    returns(bytes32 pwd)
    {
        ...
        require(_affordableData(msg.sender,_providerID)>usageTolerance);
        //change receiver identity to PAIRED
        _sur(msg.sender, role.ISRECEIVER, role.PAIRED);
